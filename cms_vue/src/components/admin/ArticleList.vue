<template>
	<div>
	    ...
	    <div class ="mytable">
	      ...
	      <el-select v-model="articleType" placeholder="请选择类别">
	            <el-option
        ...
        <el-button v-on:click = "status = 3">已发布</el-button>
        <el-button v-on:click = "status = 2">未发布</el-button>
        <el-button v-on:click = "status = 0">待审核</el-button>
	      <el-button  type="primary" v-on:click = "addArticle">添加文章</el-button>
	    </div>
