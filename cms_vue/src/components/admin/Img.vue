<template>
	<div>
	    ...
	    <div class ="mytable">
         <el-button plain v-on:click = "pf = 'jpg'">.jpg</el-button>
         <el-button plain v-on:click = "pf = 'png'">.png</el-button>
         <el-button plain v-on:click = "pf = 'gif'">.gif</el-button>
         <el-button plain v-on:click = "pf = 'jpeg'">.jpeg</el-button>
         <el-button type="primary" icon="el-icon-plus" v-on:click="addImgClick">添加图片</el-button>
	    </div>
